          ...
          <Stack spacing={3}>
            ...
            <Card sx={{ borderRadius: 1 }} variant="outlined">
              ...
              >
                ...
                <PropertyItem name="Job Position" value={data?.positionName || data?.job?.positionName || "N/A"} />

                <PropertyItem name="Job Category" value={data?.jobCategory?.name || "N/A" } />


                
                <PropertyItem name="Nationality" value={data?.nationality || "N/A"} />
