...
import {getCareerConfiguration, getJobCategories} from '@/services/jobs.api'
  ...
  return (
    ...
    >
      <Stack spacing={4}>
        <Stack spacing={3}>
          <div>
            <Link
              ...
              href={paths.dashboard.jobs.dashboard}
        ...
        {locations && jobType && categories  && <JobPostCreateForm categories={categories} jobType={jobType} locations={locations} isEdit={false} /> }
      </Stack>
    </Box>
  );
}
